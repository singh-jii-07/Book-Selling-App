...
const Sidebar = ({ data }) => {
  ...
  if (!data) {
    return (
      <div
        className="bg-zinc-900 text-white p-6 rounded-xl w-full h-full shadow-lg flex justify-center items-center"
        data-aos="fade-in"
      >
  ...
  return (
    <div
      className="bg-zinc-900 text-white p-6 rounded-xl w-full h-full shadow-lg flex flex-col justify-between items-center"
      data-aos="fade-up"
    >
